...
mod tests {
    ...
    fn known_models_produce_deterministic_costs() {
        ...
        let gemini_cost =
            estimate_cost(&AgentId::gemini("2.5-pro"), 1_000_000, 500_000).expect("gemini");
        let openai_cost = estimate_cost(&AgentId::codex("o3"), 1_000_000, 500_000).expect("o3");
    ...
    fn unknown_models_return_explicit_unsupported_pricing() {
        let error = estimate_cost(&AgentId::codex("unknown-model"), 1_000, 1_000).unwrap_err();
